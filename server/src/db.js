...
CREATE TABLE IF NOT EXISTS payments (
  ...
  method TEXT NOT NULL DEFAULT 'havale' CHECK (method IN ('havale','nakit','kart','diger')),
  paid_at TEXT,
  note TEXT,
  invoice_no TEXT,
  created_at TEXT NOT NULL DEFAULT ${NOW}
...
export async function initSchema() {
  ...
  for (const stmt of [
    ...
    'ALTER TABLE seasons ADD COLUMN image_path TEXT',
    ...
    'ALTER TABLE organizations ADD COLUMN tax_office TEXT',
    ...
    'ALTER TABLE teams ADD COLUMN tax_number TEXT',
